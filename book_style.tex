...
\usepackage{verbatim}
\usepackage{fancyvrb} % frame around verbatim
\usepackage{fvextra} % for long line break
...
\usepackage[most]{tcolorbox} % see https://tex.stackexchange.com/a/237855/117615
\tcbset{colback=yellow!10!white, colframe=orange!50!orange, 
...
% Avoid conflict between physics and siunitx
% Sadly, this is error for Linux
...
\newcommand{\ih}[1]{\inlinehighlight{#1}}
...
% change equation numbering format
% {chapter}.{section}.{no. of equation}
