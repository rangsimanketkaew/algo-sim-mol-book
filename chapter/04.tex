...
\noindent \bful{Step 4: คำนวณมุมพันธะที่อยู่ด้านนอกระนาบ (Out-of-Plane Angles)}

\vspace{5pt}

\noindent \bful{Step 5: คำนวณมุมบิด (Torsion หรือ Dihedral Angles)}

\vspace{5pt}

\noindent \bful{Step 6: คำนวณจุดศูนย์กลางมวล มุมบิด (Center of Mass)}
