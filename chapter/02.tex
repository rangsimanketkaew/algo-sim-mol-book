...
นิวเคลียส (Nuclear Charges) $\left\{Z_{I}\right\}$ (โดยที่ $I = 1,2, \ldots, N$ และ $N$ คือจำนวนของอะตอม) 
และความหนาแน่นของอิเล็กตรอน $\rho(\vec{r})$ ซึ่งเรามีความสัมพันธ์ของทั้งสองพารามิเตอร์ดังต่อไปนี้
...
\idxen{Lennard-Jones Potential}
%----------------------------------------

%----------------------------------------
\subsubsection{Many-Body Interactions}
\idxen{Many-Body Interactions}
%----------------------------------------
