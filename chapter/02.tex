...
ที่สภาวะสมดุล (Equilibrium Bond Length) $l_{i,0}$ อย่างไรก็ตามถึงแม้ว่าเราอยากให้พารามิเตอร์ประเภทนี้นั้นมีแค่ค่าเพียงแค่ค่าเดียวสำหรับ%
อะตอมแต่ละชนิดแต่ว่าในความเป็นจริงนั้นเราไม่สามารถทำได้เพราะว่าถึงแม้ว่าธาตุชนิดเดียวกัน เช่น คาร์บอนที่อยู่ในหมู่ Mehtyl Group (\ce{-CH3}) 
กับหมู่ \ce{C=O} นั้นจะมี Characteristics ต่างกันดังนั้นจึงทำให้มีคุณสมบัติที่แตกต่างกัน
