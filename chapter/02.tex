...
\idxth{อันตรกิริยาระหว่างโมเลกุล!อันตรกิริยาของระบบหลายวัตถุ}
\idxen{Intermolecular Interactions!Many-Body Interactions}
%----------------------------------------
...
%----------------------------------------
\subsection{อนุพันธ์อันดับที่หนึ่งของพลังงาน}
\idxth{อนุพันธ์อันดับที่หนึ่งของพลังงาน}
\idxen{First-Order Energy}
%----------------------------------------

%----------------------------------------
\subsection{อนุพันธ์ลำดับที่สองของพลังงาน}
\idxth{อนุพันธ์อันดับที่สองของพลังงาน}
