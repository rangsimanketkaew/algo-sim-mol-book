...
\begin{equation}
  ...
  -\underbrace{\left\langle\Psi_0\left|\mathcal{H}_{\mathrm{e}}\right| \Psi_0\right\rangle}_{\text{พลังงานศักย์}}
...
\begin{align}
  M_I \ddot{\mathbf{R}}_I(t)
   & =
  -\frac{\partial}{\partial \mathbf{R}_I}\left\langle\Psi_0\left|\mathcal{H}_{\mathrm{e}}\right| \Psi_0\right\rangle
  +\frac{\partial}{\partial \mathbf{R}_I}\{\text{ constraints }\} \\
  \mu_i \ddot{\psi}_i(t)
   & =
  <-\frac{\delta}{\delta \psi_i^{\star}}\left\langle\Psi_0\left|\mathcal{H}_{\mathrm{e}}\right| \Psi_0\right\rangle
